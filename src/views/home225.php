...
<section class="py-12">
  <div class="container mx-auto px-4 flex flex-col items-center">
    ...
    <div id="excos-grid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full justify-items-center">
      ...
      ?>
      <div class="rounded-xl shadow p-4 flex flex-col items-center relative hover:scale-105 transition-transform member-card text-center w-full max-w-xs min-w-[220px]">
